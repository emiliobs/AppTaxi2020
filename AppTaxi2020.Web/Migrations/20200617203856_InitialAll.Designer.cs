...
namespace AppTaxi2020.Web.Migrations
{
    ...
    [Migration("20200617203856_InitialAll")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppTaxi2020.Web.Data.Entities.UserGroupDetailEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("UserGroupDetailEntities");
                });
            ...
            modelBuilder.Entity("AppTaxi2020.Web.Data.Entities.UserGroupRequestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("UserGroupRequestEntities");
                });
            ...
            modelBuilder.Entity("AppTaxi2020.Web.Data.Entities.UserGroupDetailEntity", b =>
                {
                    b.HasOne("AppTaxi2020.Web.Data.Entities.UserGroupEntity", "UserGroup")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("AppTaxi2020.Web.Data.Entities.UserGroupRequestEntity", b =>
                {
                    b.HasOne("AppTaxi2020.Web.Data.Entities.UserEntity", "ProposalUser")
                        .WithMany()
                        .HasForeignKey("ProposalUserId");

                    b.HasOne("AppTaxi2020.Web.Data.Entities.UserEntity", "RequiredUser")
                        .WithMany()
