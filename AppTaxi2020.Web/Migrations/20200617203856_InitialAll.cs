        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Taxis_AspNetUsers_UserEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGroupRequestEntities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserGroupRequestEntities_AspNetUsers_ProposalUserId",
                        column: x => x.ProposalUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserGroupRequestEntities_AspNetUsers_RequiredUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGroupDetailEntities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserGroupDetailEntities_UserGroupEntities_UserGroupId",
                        column: x => x.UserGroupId,
                        principalTable: "UserGroupEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserGroupDetailEntities_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserGroupDetailEntities_UserGroupId",
                table: "UserGroupDetailEntities",
                column: "UserGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGroupDetailEntities_UserId",
                table: "UserGroupDetailEntities",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserGroupRequestEntities_ProposalUserId",
                table: "UserGroupRequestEntities",
                column: "ProposalUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGroupRequestEntities_RequiredUserId",
                table: "UserGroupRequestEntities",
